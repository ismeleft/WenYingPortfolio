...
正當我以為自己理解了大部分之後，剛好看到 Vivian 這篇 （時機來的太剛好）
有人幫我更深入先探討一遍又整理好，甚是感謝。

[【前端基礎】JavaScript 中的閉包是什麼？React 閉包應用情境 | Vivian Yeh - 跨領域轉職的前端工程師](https://vocus.cc/article/65bb95f8fd89780001ba5756)

特別是有關 閉包在 React 中的實際應用，原來是這麼一回事啊，真心推薦大家都可以去看看。